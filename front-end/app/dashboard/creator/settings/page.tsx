      ...
      <main className="flex-1 overflow-auto">
        <div className="p-8 max-w-2xl">
          <div className="mb-8">
            ...
            <p className="text-muted">Manage your account and campaign preferences.</p>
          </div>
          ...
          <div className="space-y-6">
            ...
            <div className="card-base">
              <h3 className="text-lg font-bold text-foreground mb-4">Campaign Preferences</h3>
              <div className="space-y-4">
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded" />
                  <span className="text-foreground">Enable automatic reward distribution</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded" />
                  <span className="text-foreground">Notify me of new fan milestones</span>
                </label>
                <label className="flex items-center gap-3 cursor-pointer">
                  <input type="checkbox" className="w-4 h-4 rounded" />
                  <span className="text-foreground">Allow fan-to-fan reward transfers</span>
                </label>
              </div>
            </div>
